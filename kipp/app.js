...
const DB = {
    ...
    history: [
        ...
        { id: 5, pregunta: '¿Qué hora es?',                         respuesta: 'No tengo acceso al reloj directamente desde aqui, pero puedes preguntarme eso cuando estoy activo por voz y lo leo del sistema del ESP32.',                                                                                                        fecha: new Date(Date.now() - 86400000).toISOString(), tiempo_ms: 610,  personalidad: 'Tecnico'  }
    ],
