...
const DB = {
    ...
    history: [
        ...
        { id: 4, pregunta: '¿Quién es KIPP de Interstellar?',        respuesta: 'En Interstellar los robots se llaman TARS y CASE, no KIPP. Pero hay una teoría interesante: mi nombre podría ser un guiño a Kip Thorne, el físico que asesoró científicamente la película. Así que en cierto modo... estamos en la misma galaxia. 🚀', fecha: new Date(Date.now() - 7200000).toISOString(),  tiempo_ms: 1100, personalidad: 'Formal'   },
