...
const DB = {
    ...
    history: [
        { id: 1, pregunta: 'Hola',                                  respuesta: '¡Hola! Soy KIPP, tu asistente personal por voz. Estoy listo para ayudarte. ¿En qué te puedo ayudar?',                                                                                                                               fecha: new Date(Date.now() - 300000).toISOString(),   tiempo_ms: 512,  personalidad: 'Informal' },
        ...
        { id: 3, pregunta: 'test',                                   respuesta: 'Sistema operativo. Micrófono activo. Conexión a API estable. Todo funciona correctamente. ✔',                                                                                                                                             fecha: new Date(Date.now() - 3600000).toISOString(),  tiempo_ms: 290,  personalidad: 'Técnico'  },
        { id: 4, pregunta: '¿Quién es KIPP de Interstellar?',        respuesta: '¡Ese soy yo! Bueno, mi inspiración. KIPP es uno de los cuatro robots tácticos de Interstellar junto a TARS, CASE y PLEX. Era el compañero del Dr. Mann en su misión. Su nombre es un homenaje a Kip Thorne, el físico que asesoró la película. Y el de tu KIPP también. 🚀', fecha: new Date(Date.now() - 7200000).toISOString(),  tiempo_ms: 1100, personalidad: 'Formal'   },
        { id: 5, pregunta: '¿Qué hora es?',                         respuesta: 'No tengo acceso al reloj directamente desde aquí, pero puedes preguntarme eso cuando estoy activo por voz y lo leo del sistema del ESP32.',                                                                                                  fecha: new Date(Date.now() - 86400000).toISOString(), tiempo_ms: 610,  personalidad: 'Técnico'  }
    ],
